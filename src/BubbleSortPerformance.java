...
public class BubbleSortPerformance {
    ...
    public static void main(String[] args) {
        ...
        runFullExperiment("BubbleSort-Exp1.txt");
    ...
    public static void verifySorted(){
        ...
        bubbleSortNumberList(testList1);
        ...
        bubbleSortNumberList(testList2);
        ...
        bubbleSortNumberList(testList3);
    ...
    public static void runFullExperiment(String resultsFileName){
        ...
        for(int inputSize=MININPUTSIZE;inputSize<=MAXINPUTSIZE; inputSize*=2) {
            ...
            for (long trial = 0; trial < numberOfTrials; trial++) {
                ...
                BubbleSortPerformance.bubbleSortNumberList(testList);
